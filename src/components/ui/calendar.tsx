  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cx(buttonVariants({ variant: 'ghost' }), 'h-9 w-9 p-0 font-normal aria-selected:opacity-100'),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft stroke="#821744" />,
        IconRight: ({ ...props }) => <ChevronRight stroke="#821744" />
      }}
      {...props}
    />
  );
